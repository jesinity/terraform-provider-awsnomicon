...
- Acronym policy in Sigil Azure mode: defaults to 4-character acronyms, with automatic 5-character expansion when needed to avoid clashes
- Default acronyms are derived from CAF slugs and normalized to Sigil defaults (for example, storage account `st` becomes `stac`)
...
| `azurerm_api_management` | `apima` | `global` | `non-regional` | 1 | 50 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,48}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_api` | `apimp` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_api_operation_tag` | `apimi` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_backend` | `apimm` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_certificate` | `apimn` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_gateway` | `apimg` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_group` | `apime` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_logger` | `apimt` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_service` | `apims` | `global` | `non-regional` | 1 | 50 | `true` | `false` | `^[a-z][a-zA-Z0-9-]{0,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_application_insights` | `appia` | `resourceGroup` | `regional` | 1 | 260 | `true` | `false` | `^[^%&\\?/. ][^%&\\?/]{0,258}[^%&\\?/. ]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_application_insights_web_test` | `appip` | `resourceGroup` | `regional` | 1 | 64 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9- ]{0,62}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_bot_channels_registration` | `botcb` | `parent` | `regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-_.]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_bot_connection` | `botco` | `parent` | `regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-_.]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_bot_service_azure_bot` | `botab` | `global` | `non-regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-_.]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_bot_web_app` | `botao` | `global` | `non-regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-_.]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_cdn_frontdoor_origin` | `cfdoc` | `parent` | `regional` | 1 | 90 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-]{0,88}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_cdn_frontdoor_origin_group` | `cfdod` | `parent` | `regional` | 1 | 90 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-]{0,88}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_cdn_frontdoor_route` | `cfdrc` | `parent` | `regional` | 1 | 90 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-]{0,88}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_cdn_frontdoor_rule` | `cfdrd` | `parent` | `regional` | 1 | 60 | `false` | `false` | `^[a-zA-Z][a-zA-Z0-9]{0,59}$` | `pascal, camel, straight` |
| `azurerm_cdn_frontdoor_rule_set` | `cfdrn` | `parent` | `regional` | 1 | 60 | `false` | `false` | `^[a-zA-Z][a-zA-Z0-9]{0,59}$` | `pascal, camel, straight` |
| `azurerm_cdn_frontdoor_secret` | `cfdsc` | `parent` | `regional` | 2 | 260 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_cdn_frontdoor_security_policy` | `cfdsd` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[0-9A-Za-z_-]{1,260}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_cognitive_account` | `cogac` | `resourceGroup` | `regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{0,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_cognitive_deployment` | `cogao` | `resourceGroup` | `regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{0,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_dashboard` | `dsbad` | `parent` | `regional` | 3 | 160 | `true` | `false` | `^[a-zA-Z0-9-]{3,160}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_dataset_cosmosdb_sqlapi` | `adfsd` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_dataset_mysql` | `adfmd` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_dataset_postgresql` | `adfpd` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_dataset_sql_server_table` | `adfma` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_linked_service_azure_blob_storage` | `adfld` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_azure_databricks` | `adfla` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_azure_function` | `adflt` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_azure_sql_database` | `adflf` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_cosmosdb` | `adflc` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_data_lake_storage_gen2` | `adfsa` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_key_vault` | `adfst` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_mysql` | `adfsf` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_postgresql` | `adfsc` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_sftp` | `adflo` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_sql_server` | `adfso` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_web` | `adfsr` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_pipeline` | `adfpa` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_protection_backup_policy_blob_storage` | `dpbpd` | `resourceGroup` | `regional` | 3 | 150 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9\\-]{1,148}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_protection_backup_policy_disk` | `dpbpa` | `resourceGroup` | `regional` | 3 | 150 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9\\-]{1,148}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_protection_backup_policy_postgresql` | `dpbpt` | `resourceGroup` | `regional` | 3 | 150 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9\\-]{1,148}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_protection_backup_policy_postgresql_flexible_server` | `dpbpp` | `resourceGroup` | `regional` | 3 | 150 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9\\-]{1,148}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_dev_test_linux_virtual_machine` | `labvd` | `parent` | `regional` | 1 | 64 | `true` | `false` | `^[a-zA-Z0-9-]{1,64}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dev_test_windows_virtual_machine` | `labve` | `parent` | `regional` | 1 | 15 | `true` | `false` | `^[a-zA-Z0-9-]{1,15}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_digital_twins_endpoint_eventgrid` | `adted` | `parent` | `regional` | 3 | 50 | `true` | `false` | `^[a-zA-Z0-9_-]{1,50}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_digital_twins_endpoint_eventhub` | `adtei` | `parent` | `regional` | 3 | 50 | `true` | `false` | `^[a-zA-Z0-9_-]{1,50}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_digital_twins_instance` | `adtad` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_dns_a_record` | `dnsrd` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_aaaa_record` | `dnsrn` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_caa_record` | `dnsrs` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_cname_record` | `dnsrc` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_mx_record` | `dnsrm` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_ns_record` | `dnsrr` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_ptr_record` | `dnsrp` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_txt_record` | `dnsrt` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_eventhub_namespace` | `ehnae` | `global` | `non-regional` | 1 | 50 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_eventhub_namespace_authorization_rule` | `ehnav` | `parent` | `regional` | 1 | 50 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_integration_service_environment` | `lappi` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\-\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_iot_security_solution` | `iotsi` | `resourceGroup` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9-_]{1,260}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_iotcentral_application` | `iotai` | `global` | `non-regional` | 2 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$` | `dashed, straight` |
| `azurerm_iothub` | `iotao` | `global` | `non-regional` | 3 | 50 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{1,48}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_iothub_certificate` | `iotci` | `parent` | `regional` | 1 | 64 | `true` | `false` | `^[a-zA-Z0-9-._]{1,64}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_iothub_consumer_group` | `iotco` | `parent` | `regional` | 1 | 50 | `true` | `false` | `^[a-zA-Z0-9-._]{1,50}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_iothub_shared_access_policy` | `iotso` | `parent` | `regional` | 1 | 64 | `true` | `false` | `^[a-zA-Z0-9-._]{1,64}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_lb_backend_address_pool` | `adtal` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_lb_backend_pool` | `adtab` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_lb_nat_pool` | `adtan` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_lb_outbound_rule` | `adtao` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_lb_probe` | `adtap` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_lb_rule` | `adtar` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_linux_virtual_machine` | `vimal` | `resourceGroup` | `regional` | 1 | 64 | `true` | `false` | `^[^\\/\"\\[\\]:|<>+=;,?*@&_][^\\/\"\\[\\]:|<>+=;,?*@&]{0,62}[^\\/\"\\[\\]:|<>+=;,?*@&.-]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_linux_virtual_machine_scale_set` | `vmssl` | `resourceGroup` | `regional` | 1 | 64 | `true` | `false` | `^[^\\/\"\\[\\]:|<>+=;,?*@&_][^\\/\"\\[\\]:|<>+=;,?*@&]{0,62}[^\\/\"\\[\\]:|<>+=;,?*@&.-]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_logic_app_action_custom` | `lappl` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_action_http` | `lappo` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_integration_account` | `lappg` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_trigger_custom` | `lappc` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_trigger_http_request` | `lappa` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_trigger_recurrence` | `lappp` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_workflow` | `lappw` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mariadb_database` | `marim` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mariadb_firewall_rule` | `maria` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mariadb_server` | `marir` | `global` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-zA-Z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mariadb_virtual_network_rule` | `marii` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_monitor_activity_log_alert` | `adfmm` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[^<>*%:&?#\\+\\/]{0,259}[^<>*%:&.?#\\+\\/]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mssql_elasticpool` | `sqlem` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[^<>*%:.?\\+\\/]{1,127}[^<>*%:.?\\+\\/ ]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mssql_mi` | `sqlm` | `global` | `non-regional` | 1 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$` | `dashed, straight` |
| `azurerm_mssql_server` | `sqlam` | `global` | `non-regional` | 1 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$` | `dashed, straight` |
| `azurerm_mysql_database` | `mysqm` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_firewall_rule` | `mysqy` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_flexible_server` | `mysqs` | `global` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-zA-Z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_flexible_server_database` | `mysqq` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_flexible_server_firewall_rule` | `mysql` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_server` | `mysqe` | `global` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-zA-Z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_virtual_network_rule` | `mysqv` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_network_security_group_rule` | `nsgrn` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_network_security_rule` | `nsgre` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_notification_hub_authorization_rule` | `dnsro` | `parent` | `regional` | 1 | 256 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,255}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_notification_hub_namespace` | `dnsri` | `global` | `non-regional` | 6 | 50 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{4,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_portal_dashboard` | `dsbap` | `parent` | `regional` | 3 | 160 | `true` | `false` | `^[a-zA-Z0-9-]{3,160}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_database` | `psqlp` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_firewall_rule` | `psqlo` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_flexible_server` | `psqls` | `global` | `non-regional` | 3 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$` | `dashed, straight` |
| `azurerm_postgresql_flexible_server_database` | `psqlt` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_flexible_server_firewall_rule` | `psqlg` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_server` | `psqlr` | `global` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-zA-Z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_virtual_network_rule` | `psqle` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_powerbi_embedded` | `pbia` | `region` | `regional` | 3 | 63 | `false` | `false` | `^[a-z0-9][a-z0-9]{2,62}$` | `pascal, camel, straight` |
| `azurerm_private_dns_a_record` | `pdnsp` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_aaaa_record` | `pdnsr` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_cname_record` | `pdnsi` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_mx_record` | `pdnsv` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_ptr_record` | `pdnsa` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver` | `dnspp` | `resourceGroup` | `regional` | 3 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{1,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_dns_forwarding_ruleset` | `dnsfp` | `resourceGroup` | `regional` | 2 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{0,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_forwarding_rule` | `dnsfr` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-_]{0,78}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_inbound_endpoint` | `dnspr` | `parent` | `regional` | 3 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{1,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_outbound_endpoint` | `dnspi` | `parent` | `regional` | 3 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{1,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_virtual_network_link` | `dnsfi` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-_]{0,78}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_srv_record` | `pdnst` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_txt_record` | `pdnse` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_zone` | `pdnsd` | `resourceGroup` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,61}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_zone_group` | `pdnsn` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_redis_cache` | `redir` | `global` | `non-regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_redis_firewall_rule` | `redie` | `parent` | `regional` | 1 | 256 | `false` | `false` | `^[a-zA-Z0-9]{1,256}$` | `pascal, camel, straight` |
...
| `azurerm_route` | `routr` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_route_table` | `routo` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_servicebus_queue` | `sbqas` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,258}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_servicebus_queue_authorization_rule` | `sbqae` | `parent` | `regional` | 1 | 50 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_servicebus_topic` | `sbtas` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_servicebus_topic_authorization_rule` | `sbtae` | `parent` | `regional` | 1 | 50 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_sql_elasticpool` | `sqles` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[^<>*%:.?\\+\\/]{1,127}[^<>*%:.?\\+\\/ ]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_sql_failover_group` | `sqlfs` | `global` | `non-regional` | 1 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$` | `dashed, straight` |
| `azurerm_sql_firewall_rule` | `sqlfq` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[^<>*%:?\\+\\/]{1,127}[^<>*%:.?\\+\\/]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_sql_server` | `sqlas` | `global` | `non-regional` | 1 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$` | `dashed, straight` |
...
| `azurerm_storage_share` | `stsas` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_storage_share_directory` | `stsat` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_stream_analytics_output_blob` | `asaos` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_eventhub` | `asaot` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_mssql` | `asaor` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_servicebus_queue` | `asaoe` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_servicebus_topic` | `asaoa` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_stream_analytics_stream_input_blob` | `asais` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_stream_input_eventhub` | `asait` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_stream_input_iothub` | `asair` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_synapse_integration_runtime_azure` | `synis` | `subscription` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9-]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_synapse_integration_runtime_self_hosted` | `syniy` | `subscription` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9_-]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_synapse_sql_pool` | `synss` | `subscription` | `non-regional` | 3 | 15 | `false` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9_]{1,13}[a-zA-Z0-9]$` | `pascal, camel, straight` |
| `azurerm_synapse_sql_pool_vulnerability_assessment_baseline` | `synsy` | `subscription` | `non-regional` | 3 | 63 | `false` | `false` | `^[a-zA-Z0-9]{1,63}$` | `pascal, camel, straight` |
| `azurerm_synapse_sql_pool_workload_classifier` | `synsn` | `subscription` | `non-regional` | 1 | 128 | `true` | `false` | `^[^<>*%:?\\+\\/]{1,127}[^<>*%:.?\\+\\/]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_synapse_sql_pool_workload_group` | `synsa` | `subscription` | `non-regional` | 1 | 128 | `true` | `false` | `^[^<>*%:.?\\+\\/]{0,127}[^<>*%:.?\\+\\/ ]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_virtual_machine` | `vimav` | `resourceGroup` | `regional` | 1 | 15 | `true` | `false` | `^[^\\/\"\\[\\]:|<>+=;,?*@&_][^\\/\"\\[\\]:|<>+=;,?*@&]{0,13}[^\\/\"\\[\\]:|<>+=;,?*@&.-]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_virtual_machine_scale_set` | `vmssv` | `resourceGroup` | `regional` | 1 | 15 | `true` | `false` | `^[^\\/\"\\[\\]:|<>+=;,?*@&_][^\\/\"\\[\\]:|<>+=;,?*@&]{0,13}[^\\/\"\\[\\]:|<>+=;,?*@&.-]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_virtual_machine_scale_set_extension` | `vmssi` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_windows_virtual_machine` | `vimaw` | `resourceGroup` | `regional` | 1 | 15 | `true` | `false` | `^[^\\/\"\\[\\]:|<>+=;,?*@&_][^\\/\"\\[\\]:|<>+=;,?*@&]{0,13}[^\\/\"\\[\\]:|<>+=;,?*@&.-]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_windows_virtual_machine_scale_set` | `vmssw` | `resourceGroup` | `regional` | 1 | 15 | `true` | `false` | `^[^\\/\"\\[\\]:|<>+=;,?*@&_][^\\/\"\\[\\]:|<>+=;,?*@&]{0,13}[^\\/\"\\[\\]:|<>+=;,?*@&.-]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `general` | `geneg` | `global` | `non-regional` | 1 | 250 | `true` | `false` | `^[a-zA-Z0-9-_]{1,250}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `general_safe` | `genee` | `global` | `non-regional` | 1 | 250 | `false` | `true` | `^[a-z]{1,250}$` | `straight` |
