...
| `azurerm_api_management_api` | `apima` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_api_operation_tag` | `apimt` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_backend` | `apimb` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_certificate` | `apimc` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_gateway` | `apimw` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_group` | `apimg` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_api_management_logger` | `apiml` | `global` | `non-regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{0,78}[a-zA-Z0-9|]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_application_insights_web_test` | `appit` | `resourceGroup` | `regional` | 1 | 64 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9- ]{0,62}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_bot_channels_registration` | `botcr` | `parent` | `regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-_.]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_bot_service_azure_bot` | `botaa` | `global` | `non-regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-_.]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_cdn_frontdoor_route` | `cfdrr` | `parent` | `regional` | 1 | 90 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-]{0,88}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_cognitive_deployment` | `cogad` | `resourceGroup` | `regional` | 2 | 64 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{0,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_dataset_cosmosdb_sqlapi` | `adfsq` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_dataset_postgresql` | `adfpp` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_dataset_sql_server_table` | `adfmt` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,258}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_linked_service_azure_blob_storage` | `adfls` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_azure_databricks` | `adflt` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_azure_function` | `adflf` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_azure_sql_database` | `adfld` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_linked_service_data_lake_storage_gen2` | `adfsg` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_key_vault` | `adfsv` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_mysql` | `adfsm` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_data_factory_linked_service_postgresql` | `adfsp` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_factory_linked_service_sql_server` | `adfss` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[a-zA-Z0-9][^<>*%:.?\\+\\/]{0,259}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_protection_backup_policy_blob_storage` | `dpbpt` | `resourceGroup` | `regional` | 3 | 150 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9\\-]{1,148}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_data_protection_backup_policy_postgresql_flexible_server` | `dpbps` | `resourceGroup` | `regional` | 3 | 150 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9\\-]{1,148}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_dev_test_windows_virtual_machine` | `labvw` | `parent` | `regional` | 1 | 15 | `true` | `false` | `^[a-zA-Z0-9-]{1,15}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_digital_twins_endpoint_eventgrid` | `adtee` | `parent` | `regional` | 3 | 50 | `true` | `false` | `^[a-zA-Z0-9_-]{1,50}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_digital_twins_instance` | `adtai` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_dns_aaaa_record` | `dnsra` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_caa_record` | `dnsrc` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_dns_cname_record` | `dnsre` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_dns_ns_record` | `dnsrn` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_integration_service_environment` | `lappe` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\-\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_iotcentral_application` | `iotaa` | `global` | `non-regional` | 2 | 63 | `true` | `true` | `^[a-z0-9][a-z0-9-]{0,61}[a-z0-9]$` | `dashed, straight` |
...
| `azurerm_iothub_shared_access_policy` | `iotsp` | `parent` | `regional` | 1 | 64 | `true` | `false` | `^[a-zA-Z0-9-._]{1,64}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_lb_backend_address_pool` | `adtaa` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_lb_backend_pool` | `adtap` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_lb_probe` | `adtar` | `subscription` | `non-regional` | 4 | 63 | `true` | `false` | `^[a-zA-Z0-9_-]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_logic_app_action_custom` | `lappc` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_action_http` | `lapph` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_integration_account` | `lappa` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_trigger_custom` | `lapps` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_trigger_http_request` | `lappr` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_logic_app_trigger_recurrence` | `lappn` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[0-9A-Za-z\\(\\-\\)\\_\\.]{1,80}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mariadb_database` | `marid` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mariadb_firewall_rule` | `marif` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mariadb_virtual_network_rule` | `marin` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_monitor_activity_log_alert` | `adfma` | `parent` | `regional` | 1 | 260 | `true` | `false` | `^[^<>*%:&?#\\+\\/]{0,259}[^<>*%:&.?#\\+\\/]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mysql_database` | `mysqd` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_mysql_firewall_rule` | `mysqr` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mysql_flexible_server_database` | `mysqt` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_mysql_virtual_network_rule` | `mysqn` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_network_security_group_rule` | `nsgrg` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_notification_hub_authorization_rule` | `dnsrr` | `parent` | `regional` | 1 | 256 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,255}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_notification_hub_namespace` | `dnsrs` | `global` | `non-regional` | 6 | 50 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-]{4,48}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_postgresql_database` | `psqld` | `parent` | `regional` | 1 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{1,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_postgresql_firewall_rule` | `psqlr` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_postgresql_flexible_server_firewall_rule` | `psqll` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_postgresql_virtual_network_rule` | `psqln` | `parent` | `regional` | 1 | 128 | `true` | `false` | `^[a-zA-Z0-9-_]{1,128}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_powerbi_embedded` | `pbia` | `region` | `regional` | 3 | 63 | `false` | `false` | `^[a-z0-9][a-z0-9]{2,62}$` | `pascal, camel, straight` |
| `azurerm_private_dns_a_record` | `pdnsa` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_private_dns_cname_record` | `pdnsc` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_mx_record` | `pdnsm` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_ptr_record` | `pdnsp` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_private_dns_resolver_dns_forwarding_ruleset` | `dnsfr` | `resourceGroup` | `regional` | 2 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{0,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_private_dns_resolver_inbound_endpoint` | `dnspi` | `parent` | `regional` | 3 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{1,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_outbound_endpoint` | `dnspo` | `parent` | `regional` | 3 | 80 | `true` | `false` | `^[a-zA-Z][a-zA-Z0-9-_]{1,78}[a-zA-Z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_resolver_virtual_network_link` | `dnsfl` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9]([a-zA-Z0-9-_]{0,78}[a-zA-Z0-9])?$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_srv_record` | `pdnss` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_private_dns_txt_record` | `pdnst` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_private_dns_zone_group` | `pdnsg` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_redis_firewall_rule` | `redir` | `parent` | `regional` | 1 | 256 | `false` | `false` | `^[a-zA-Z0-9]{1,256}$` | `pascal, camel, straight` |
...
| `azurerm_route_table` | `routt` | `resourceGroup` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_storage_share_directory` | `stsad` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-z0-9][a-z0-9-]{1,61}[a-z0-9]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_stream_analytics_output_eventhub` | `asaoe` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_mssql` | `asaom` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_servicebus_queue` | `asaoq` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_output_servicebus_topic` | `asaot` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_stream_analytics_stream_input_eventhub` | `asaie` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_stream_analytics_stream_input_iothub` | `asaii` | `parent` | `regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9-_]{3,63}$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_synapse_integration_runtime_self_hosted` | `synih` | `subscription` | `non-regional` | 3 | 63 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9-]{1,61}[a-zA-Z0-9_-]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_synapse_sql_pool_vulnerability_assessment_baseline` | `synsb` | `subscription` | `non-regional` | 3 | 63 | `false` | `false` | `^[a-zA-Z0-9]{1,63}$` | `pascal, camel, straight` |
| `azurerm_synapse_sql_pool_workload_classifier` | `synsc` | `subscription` | `non-regional` | 1 | 128 | `true` | `false` | `^[^<>*%:?\\+\\/]{1,127}[^<>*%:.?\\+\\/]$` | `dashed, pascaldashed, pascal, camel, straight` |
| `azurerm_synapse_sql_pool_workload_group` | `synsg` | `subscription` | `non-regional` | 1 | 128 | `true` | `false` | `^[^<>*%:.?\\+\\/]{0,127}[^<>*%:.?\\+\\/ ]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `azurerm_virtual_machine_scale_set_extension` | `vmsse` | `parent` | `regional` | 1 | 80 | `true` | `false` | `^[a-zA-Z0-9][a-zA-Z0-9\\-\\._]{0,78}[a-zA-Z0-9_]$` | `dashed, pascaldashed, pascal, camel, straight` |
...
| `general_safe` | `genes` | `global` | `non-regional` | 1 | 250 | `false` | `true` | `^[a-z]{1,250}$` | `straight` |
